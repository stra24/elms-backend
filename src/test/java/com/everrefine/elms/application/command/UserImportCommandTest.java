...
class UserImportCommandTest {
  ...
  @Test
  void 正常系_ヘッダのみCSVはCommand生成上は許容されること() {
  ...
  @Test
  void 異常系_CSVファイル形式が不正な場合はResponseStatusExceptionになること() {
  ...
  @Test
  void 異常系_ヘッダ不正時のreasonが維持されること() {
  ...
  @Test
  void 異常系_空行を挟んでも物理行番号でエラーになること() {
